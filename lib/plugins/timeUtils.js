...
exports.invertTimeZone = exports.timeZoneUnix = exports.getPastDays = exports.getLastMonth = exports.getCurrentMonth = exports.getLastWeek = exports.getCurrentWeek = exports.getCurrentByUnit = exports.getCurrentHour = void 0;
...
function timeZoneUnix(option, dayjsClass, dayjsFactory) {
    dayjsClass.prototype.timeZoneUnix = function (timezone) {
        return this.unix() + this.tsZone(timezone).utcOffset() * 60;
    };
}
exports.timeZoneUnix = timeZoneUnix;
function invertTimeZone(option, dayjsClass, dayjsFactory) {
    dayjsFactory.invertTimeZone = function (timezone) {
        return timezone.includes('+') ? timezone.replace('+', '-') : timezone.replace('-', '+');
    };
}
exports.invertTimeZone = invertTimeZone;
